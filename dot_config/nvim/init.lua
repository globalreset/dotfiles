  ...
  --{'junegunn/fzf.vim', event = 'BufRead'}, -- Fuzzy finder
 {
  ...
  { -- LSP Configuration & Plugins
    ...
    config = function()
      ...
      -- For blink.cmp: comment the line above and uncomment the line below
      ...
      local servers = {
        ...
        --   cmd = {'/home/shughes/verible-v0.0-3622-g07b310a3/bin/verible-verilog-ls'},
  ...
  -- nvim-cmp Autocompletion (uncomment this block and comment out blink below to switch back)
  -- { -- Autocompletion
  --   'hrsh7th/nvim-cmp',
  --   event = 'InsertEnter',
  --   dependencies = {
  ...
  -- Blink completion (comment out nvim-cmp above when using this)
  {
    'saghen/blink.cmp',
    version = '1.*',
    dependencies = {
